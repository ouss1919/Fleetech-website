        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./vehiculeTab.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Suivie des Véhicules</h1>
          </div>
        </div>
      </div>
        ...
        <div class="row mb-2">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item ">
                <a href="#" class="m-0 text-dark">Carnet véhicule</a></li>
            </ol> 
        </div>
     </section>
      <!-- /.container-fluid -->
...
<a href="exportDataVehicule.php" class="btn btn-primary"><i class="exp"></i> Export</a>
</div>
</div>
<!-- CSV file upload form -->
<div class="col-md-12" id="importFrm" style="display: none;">
<form action="importDataVehicule.php" method="post" enctype="multipart/form-data">
...
<script>
    ...
    items: [
     ...
     { Name: "essence", Id: "essence" },
     { Name: "gasoil", Id: "gasoil" }
    ...
    items: [
      { Name: "", Id: "" },
     { Name: "en panne", Id: "en panne"},
     { Name: "en maintenance", Id: "en maintenance" },
     { Name: "en bon etat", Id: "bon etat" }
    ], 
    valueField: "Id", 
    textField: "Name", 
    valueType: "string",
